function MyCalc(){
    ...
    if(document.getElementById('option1').checked){
        ...
        if(document.getElementById('sel-g').value == "val1"){
            ...
            elm.style.backgroundImage="url('img/pag-p-f/f12.jpg')";
            
            elm1.style.backgroundImage="url('img/pag-p-c/0.jpg')";
            /*===IMG===*/
        ...
        if(document.getElementById('sel-g').value == "val3"){
            ...
            elm.style.backgroundImage="url('img/pag-p-f/f32.jpg')";
        ...
        if(document.getElementById('sel-g').value == "val4"){
            ...
            elm1.style.backgroundImage="url('img/pag-p-c/1.jpg')";
             /*===IMG===*/
